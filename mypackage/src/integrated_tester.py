...
class IntegratedTester(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        self.mark_type.setFixedWidth(120)
        self.mark_id = QLineEdit()
        self.mark_id.setFixedWidth(60)
        self.mark_id.setPlaceholderText("")
        self.mark_note = QLineEdit()
        self.mark_note.setFixedWidth(60)
        self.mark_note.setPlaceholderText("")
